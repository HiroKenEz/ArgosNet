...
| Pilier | Description |
|--------|-------------|
| **Scan réseau** | Découverte ARP des hôtes, scan de ports, résolution constructeur/nom, **scans périodiques planifiés** |
...
| **Langue** | Interface **entièrement** en français ou anglais (menu **Affichage → Langue**), appliquée au redémarrage |
